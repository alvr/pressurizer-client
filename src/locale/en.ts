export default {
  ...
  account: {
    ...
    exportError: 'Error exporting your data, try again.',
    importButtonText: 'Import data',
    importError: 'Error importing your data. The file might be corrupted.',
    importSuccess: 'Your data has been imported.',
    importDialogTitle: 'Select your exported data file',
    deleteButtonText: 'Delete account',
    deleteDialogTitle: 'Delete account?',
    deleteDialogTitleConfirm: 'Are you sure?',
    deleteDialogMessage: 'If you delete your account, all data will be erased',
    deleteDialogMessageConfirm: 'This cannot be undone. Consider at least exporting your data.',
    deleteDialogCancel: 'Cancel',
    deleteDialogDone: 'Account deleted',
    deleteDialogError: 'An error happened when deleting your account.',
  },
}
